# CICD Training automation

## What this repo contains
* Terraform to create a Windows server with MSSQL DB
* Powershell scripts to fully orchestrate the installation of TeamCity, Octopus Deploy, install tentacle and configure an octopus environment 
...
| CICD_password       | The password assigned to the techtest user                         |    No     |    
| TechTestDate        | The date that the training will take place on in dd/MM/yyyy format |    No     |    
